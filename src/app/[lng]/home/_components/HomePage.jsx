...
function HomePage({ movie }) {
  return (
    <div className="h-screen pt-[156px]">
      <h1 className="text-6xl w-[300px] text-white font-bold">{movie?.title}</h1>
      <div className="flex items-center gap-[15px] mt-[21px]">
        <Image src={TopTenIcon} alt="Top Ten Icon" width={35} height={35} />
        <h2 className="text-white">#1 in Movies Today</h2>
      </div>
      <h4 className=" text-sm w-[385px] mt-[21px] h-[83px] overflow-hidden text-white">{movie?.overview}</h4>
      <div className="flex items-center gap-[15px] mt-[21px]">
