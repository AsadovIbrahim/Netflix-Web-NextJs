  ...
  return (
    <div className="flex justify-center items-center">
      <div className="flex flex-col gap-[18px]  w-[600px] mt-[137px]">
        <h1 className="md:text-5xl text-center font-bold text-white">
          { translate(`landingUnlimitedMovies`)}
        </h1>
        <p className="text-center font-bold text-white">{ translate("landingStartAt")}</p>
        <p className="text-center text-white">{ translate(`readyToWatch`)}</p>
        <div className="flex flex-wrap justify-center flex-row gap-2">
          ...
          >
            <p className="text-center text-white text-2xl"> {  translate(`getStarted`)}</p>
          </Link>
        </div>
      </div>
    </div>
